...
Focused on **Cybersecurity, Network Security, Linux Systems, and Systems Security**.
...
Nuclei • OWASP ZAP • Docker • Git • GitHub • GCC • Make • VS Code
...
Linux kernel security project demonstrating buffer-overflow exploitation, privilege escalation, and defensive mitigation techniques.
...
TCP-based file transfer system written in C demonstrating network and systems programming concepts.
...
Django-based web security application integrating **Nuclei and OWASP ZAP** to automate vulnerability scanning and security reporting.

* Automated URL-based vulnerability scans through a user-facing interface
* Processed scanner outputs into severity-based findings and risk levels
* Generated structured scan results with downloadable HTML/PDF reports
